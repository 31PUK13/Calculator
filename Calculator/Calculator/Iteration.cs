...
namespace Calculator
{
    public partial class MainWindow
    {
        class Iteration
        {
            ...
            public static bool memoryRead = false;
            ...
            public static void ChoseOperation(TextBlock input, TextBlock history, string symbol)
            {
                ...
                else
                {
                    ...
                    else if (newNumberPrint || memoryRead)
                    {
                        history.Text += input.Text + " " + symbol + " ";
                        b = double.Parse(input.Text);
                        Operation();
            ...
            public static void MemoryClear(TextBlock memory)
            {
                if (stopPrint)
                {
                    return;
            ...
            public static void MemoryRead(TextBlock input, TextBlock history)
            {
                if (stopPrint)
                {
                    return;
                ...
                memoryRead = true;
                wordOnHistory = false;
                input.Text = mem.ToString();
            }
            public static void MemorySave(TextBlock input, TextBlock memory)
            {
                if (stopPrint)
                {
                    return;
                }
                mem = double.Parse(input.Text);
                newNumberPrint = false;
                memoryRead = true;
                CheckZero(memory);
            }
            public static void MemoryPlus(TextBlock input, TextBlock memory)
            {
                if (stopPrint)
                {
                    return;
            ...
            public static void MemoryMinus(TextBlock input, TextBlock memory)
            {
                if (stopPrint)
                {
                    return;
